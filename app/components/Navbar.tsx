...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed top-0 w-full h-16 bg-black/80 backdrop-blur-3xl border-b border-[#F5C26B]/20 z-50 flex items-center px-4 md:px-6">
        ...
        <div className="hidden md:flex items-center gap-2 ml-6">
          <div className="relative">
            <button className="alert-btn relative p-2" aria-label="Notifications">
      ...
      {/* SIDEBAR - Mobile Only */}
      <aside
        className={`fixed left-0 top-16 w-64 h-[calc(100vh-64px)] bg-black/80 backdrop-blur-3xl border-r border-[#F5C26B]/20 transition-all duration-300 z-50 flex flex-col overflow-y-auto ${
