...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center bg-linear-to-br from-[#0A0A0A] via-black to-[#0A0A0A] text-[#F5C26B] relative py-10 px-4">
      {/* Background Elements */}
      <div className="fixed top-20 right-20 w-96 h-96 bg-[#F5C26B]/10 rounded-full blur-3xl animate-float pointer-events-none"></div>
      ...
      <div className="w-full max-w-2xl glass rounded-3xl p-6 md:p-12 border-2 border-[#F5C26B]/30 shadow-2xl relative z-10">
        {/* Welcome Message */}
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-transparent bg-linear-to-r from-[#F5C26B] to-[#FFD56A] bg-clip-text mb-3">
            Welcome to EMESIS
          </h2>
