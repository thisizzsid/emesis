  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute -inset-0.5 bg-gradient-to-r from-yellow-600 via-yellow-300 to-yellow-600 rounded-2xl blur opacity-20 animate-pulse" />
        ...
        <div className="relative z-10">
          ...
          <textarea
            ...
            className="
              w-full px-4 py-4 min-h-[140px] bg-zinc-900/70 border border-zinc-700 
              rounded-lg text-[#F4BC4B] placeholder-zinc-500 tracking-wide
              focus:outline-none focus:border-[#F5C26B]
            "
            value={msg}
