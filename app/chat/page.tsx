...
export default function ChatListPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[#0A0A0A] via-black to-[#0A0A0A] text-(--gold-primary) px-8 py-24 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto mt-16 glass rounded-3xl p-8 shadow-2xl border border-[rgba(var(--gold-primary-rgb),0.3)] relative z-10 animate-fadeIn hidden">
