                ...
                <div className="flex items-center justify-between gap-6 relative z-10">
                  ...
                  <div className="flex items-center gap-5 flex-1">
                    ...
                    <div className="flex-1">
                      <p className="font-bold text-2xl text-[#F5C26B] mb-1 group-hover:text-[#FFD56A] transition-colors">
                        {u.username || "No Name"}
                      </p>
                      <p className="text-sm text-zinc-600 flex items-center gap-2 mb-2">
