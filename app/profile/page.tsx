...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-[#F4BC4B] py-24 px-6 flex flex-col items-center">

      <div className="max-w-3xl w-full bg-black/40 border border-[#2A2A2A] rounded-2xl p-10 shadow-xl backdrop-blur-md space-y-10">
