      ...
      <div className={`relative z-10 w-full max-w-lg p-6 transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="glass-card rounded-3xl border border-[var(--glass-border)] shadow-[0_0_50px_-10px_rgba(var(--gold-primary-rgb),0.1)] p-8 md:p-10 backdrop-blur-2xl bg-[var(--glass-bg)] relative overflow-hidden group">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[var(--gold-primary)] via-[var(--gold-light)] to-[var(--gold-primary)] bg-clip-text text-transparent tracking-tight font-[Orbitron] mb-2 bg-size-200 animate-textShine">
              Create Account
            </h1>
            <p className="text-zinc-400 text-sm">Join the Emesis community today</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-zinc-400 text-sm">
              ...
              <Link href="/login" className="text-[var(--gold-primary)] font-bold hover:text-[var(--gold-light)] hover:underline decoration-[var(--gold-primary)]/50 underline-offset-4 transition-all">
                Log in
              </Link>
            </p>
          </div>
