...
function TiltCard({
  ...
  const onMove = (e: React.MouseEvent) => {
    ...
    setTransform(`perspective(1000px) rotateX(${rx}deg) rotateY(${ry}deg) scale(1.01)`);
  };
...
function ShimmerButton({ children, onClick, className = "" }: { children: React.ReactNode; onClick?: () => void; className?: string }) {
  return (
    <button
      onClick={onClick}
      className={`relative overflow-hidden isolate group inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-black bg-gradient-to-r from-[#F5C26B] to-[#FFD56A] shadow-2xl shadow-[#F5C26B]/30 transition-transform duration-200 active:scale-95 ${className}`}
    >
      ...
      <span className="pointer-events-none absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-700 ease-out" />
    </button>
  );
}
...
export default function AboutPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#0A0A0A] via-black to-[#0A0A0A] text-white flex flex-col">
      {/* Ambient background */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {/* soft radial glows */}
        <div className="absolute -inset-[20%] opacity-60 [mask-image:linear-gradient(to_bottom,black,transparent_75%)] bg-[radial-gradient(60%_40%_at_50%_-10%,rgba(245,194,107,0.10),transparent_70%),radial-gradient(40%_30%_at_80%_40%,rgba(255,213,106,0.08),transparent_70%),radial-gradient(30%_25%_at_15%_60%,rgba(245,194,107,0.06),transparent_70%)]" />
        {/* subtle scanlines */}
        <div className="absolute inset-0 opacity-[0.12] bg-[linear-gradient(transparent_95%,rgba(255,255,255,0.12)_95%)] bg-[length:100%_8px]" />
        {/* highlight ring */}
      ...
      <div className="relative pt-6 pb-12 px-4 md:px-6">
        <div className="absolute inset-0 bg-gradient-to-b from-[#F5C26B]/5 to-transparent"></div>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <Reveal className="opacity-0">
            <h1 className="relative inline-block text-4xl md:text-5xl font-black mb-4 bg-gradient-to-r from-[#F5C26B] to-[#FFD56A] bg-clip-text text-transparent">
              About EMESIS
              <span className="pointer-events-none absolute inset-x-0 -bottom-1 h-px bg-gradient-to-r from-transparent via-[#F5C26B]/50 to-transparent" />
            </h1>
      ...
      <div className="flex-1 px-4 md:px-6 pb-8">
        <div className="max-w-4xl mx-auto space-y-8">
          {/* Mission Section */}
          <Reveal>
            <TiltCard className="glass border border-[#F5C26B]/30 rounded-2xl p-6 md:p-8 bg-white/[0.04] backdrop-blur-xl">
            ...
            <TiltCard className="glass border border-[#F5C26B]/30 rounded-2xl p-6 md:p-8 bg-white/[0.04] backdrop-blur-xl">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  {/* Avatar */}
                  <div className="flex-shrink-0 w-24 h-24 md:w-32 md:h-32 rounded-2xl bg-gradient-to-br from-[#F5C26B]/30 to-[#FFD56A]/30 flex items-center justify-center">
            ...
            <TiltCard className="glass border border-[#F5C26B]/30 rounded-2xl p-6 md:p-8 bg-white/[0.04] backdrop-blur-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  <div
                    key={idx}
                    className="p-4 rounded-xl bg-gradient-to-br from-[#F5C26B]/10 to-[#FFD56A]/10 border border-[#F5C26B]/20 hover:border-[#F5C26B]/50 transition-all duration-300"
                  >
            ...
            <TiltCard className="glass border border-[#F5C26B]/30 rounded-2xl p-6 md:p-8 bg-white/[0.04] backdrop-blur-xl">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {["Next.js", "React", "TypeScript", "Firebase", "Tailwind CSS", "Google Gemini AI"].map((tech, idx) => (
                  <div
                    key={idx}
                    className="p-4 text-center rounded-lg bg-gradient-to-br from-[#F5C26B]/5 to-[#FFD56A]/5 border border-[#F5C26B]/20 hover:border-[#F5C26B]/50 transition-all"
                  >
          ...
          {/* Join Us CTA */}
          <Reveal>
            <TiltCard className="glass border border-[#F5C26B]/20 rounded-2xl p-8 md:p-12 text-center bg-white/[0.04] backdrop-blur-xl">
